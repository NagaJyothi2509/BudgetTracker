"""
Django settings for hubSettingss project.
...
SECRET_KEY = "8cw*e7c^fyr4gtb7b*5qxjo+gtw8$6h2j94waxp6j8x=no$toy"
...
WSGI_APPLICATION = 'hubSettings.wsgi.application'
...
AUTH_USER_MODEL = 'hubModels.HubUser'
