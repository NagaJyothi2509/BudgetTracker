...
function EditBalanceForm(props: Props) {
  ...
  const { handleSubmit, control } = useForm<EditBalanceFormData>({
  ...
  async function editBalance(data: EditBalanceFormData) {
    await mutateAsync({ value: data.balance });
  }
          ...
          <TextField
            ...
            sx={{
              ...
              "& .MuiInputBase-input::placeholder": {
                color: "black",
                opacity: 1, // ensures black placeholder
              },
            }}
            InputProps={{
